...
class User_Access extends CI_Controller
{
    ...
    public function editProfile()
	{
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('user_access/profile/editProfile', $data);
            ...
            redirect('user_access/editProfile');
        }
	}
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('templates/header', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('user_access/profile/changePassword', $data);
            $this->load->view('templates/footer');
        } else {
            ...
            if (!password_verify($current_password, $data['user']->password)) {
                ...
                redirect('user_access/changePassword');
    ...
    {
        $data['title'] = 'Last Logged';
		$username = $this->session->userdata('username');
		$data['user'] = $this->User_model->getuser($username);

		$data['member'] = $this->User_model->getAllUsers2();

		$this->load->view('templates/header',  $data);
		$this->load->view('templates/sidebar');
		$this->load->view('user_access/profile/lastLoggedOn', $data);
		$this->load->view('templates/footer');
    }
