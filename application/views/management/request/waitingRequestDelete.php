                    ...
                    <table class="table table-striped table-bordered" id="table_id" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-right">
                                ...
                                <td><?= $p->kode_barang ?></td>
                                <td><?= $p->nama_barang ?></td>
                                <td><?= $p->pesan_request_delete ?></td>
                                <td><?= date('d F Y, H:i', strtotime($p->date_request_delete)) ?></td>
                                <td>
                                    ...
                                    <a href="<?= base_url('management/approvedRequestDeleteRole2/' . $p->id_barang)  ?>"
                                        class="btn btn-sm btn-primary WR_Delete-button">
                                        Approved
                                    </a>
                                    <a href="<?= base_url('management/rejectRequestDeleteRole2/' . $p->id_barang)  ?>"
                                        class="btn btn-sm btn-outline-danger WR_Cancel-button">
                                        Reject
                                    </a>
                                    <?php elseif ($user->id_role == 3) : ?>
                                    <a href="<?= base_url('management/approvedRequestDeleteRole3/' . $p->id_barang)  ?>"
                                        class="btn btn-sm btn-primary WR_Delete-button">
                                        Approved
                                    </a>
                                    <a href="<?= base_url('management/rejectRequestDeleteRole3/' . $p->id_barang)  ?>"
                                        class="btn btn-sm btn-outline-danger WR_Cancel-button">
                                        Reject
                                    </a>
                                    <?php elseif ($user->id_role == 1) : ?>
                                    <!-- jika mode manajer, keduanya pending -->
                                    <?php if (($p->status_3 == 'Pending') && ($p->status_4 == 'Pending')) : ?>
                                    <a href="<?= base_url('management/approvedRequestDeleteRole2/' . $p->id_barang)  ?>"
                                        class="btn btn-sm btn-primary WR_Delete-button" data-bs-toggle="tooltip"
                                    ...
                                    <a href="<?= base_url('management/rejectRequestDeletAllRole/' . $p->id_barang)  ?>"
